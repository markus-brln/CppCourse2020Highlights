// Generated by Bisonc++ V6.04.03 on Mon, 29 Mar 2021 12:12:21 -44917012
...
PI_ const s_productionInfo[] = 
{
     ...
     {258, 1}, // 1: input ->  lines
     {258, 0}, // 2: input ->  <empty>
     {259, 2}, // 3: lines ->  lines line
     {259, 1}, // 4: lines ->  line
     {260, 1}, // 5: line ('\x0a') ->  '\x0a'
     {260, 2}, // 6: line ('\x0a') ->  expression '\x0a'
     {261, 3}, // 7: expression ('+') ->  expression '+' expression
     {261, 3}, // 8: expression ('-') ->  expression '-' expression
     {261, 3}, // 9: expression ('*') ->  expression '*' expression
     {261, 3}, // 10: expression ('/') ->  expression '/' expression
     {261, 3}, // 11: expression ('(') ->  '(' expression ')'
     {261, 1}, // 12: expression (NUM) ->  NUM
     {261, 2}, // 13: expression ('-') ->  '-' expression
     {261, 2}, // 14: expression ('$') ->  '$' expression
     {262, 1}, // 15: input_$ ->  input
};
